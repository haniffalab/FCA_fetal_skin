...
```mermaid
flowchart LR
    %%{init: {'themeVariables': {'fontSize': '60px', 'fontFamily': 'Inter', 'clusterBkg':'#FBD15F', 'clusterBorder':'#5FFBD1'}}}%%
    ...
    classDef white color:#022e1f,fill:#fff,stroke-width:4px
    ...
    subgraph Raw Data pre-Processing
        ...
        click B "https://github.com/haniffalab/FCA_Fetal_Skin_priv/blob/main/code/notebooks/analysis/0_collectRaw.ipynb" _parent
