...
source("~/src/github/Teichlab/sctkr/R/MonocleUtils.R")
p0_pdf <- "pooled_fsk.mesenchymal_subset.monocle.20220329.pdf"
p0_pdf <- "pooled_fsk.mesenchymal_subset.monocle.20220823.pdf"
...
fsk_ms_cds2 <- readRDS("pooled_fsk.mesenchymal_subset.monocle.20220329.downsampled.rds")
...
fsk_p1_deg <- graph_test(fsk_p1_cds2, neighbor_graph = "principal_graph", cores = 8)
...
p1_pdf <- "pooled_fsk.mesenchymal.monocle.hoxc5_early_fibroblast_to_dermal_papillia.trajectory_DE.20220711.pdf"
...
fsk_p2_deg <- graph_test(fsk_p2_cds2, neighbor_graph = "principal_graph", cores = 8)
...
p2_pdf <- "pooled_fsk.mesenchymal.monocle.hoxc5_early_fibroblast_to_pear1_fibroblast.trajectory_DE.20220823.pdf"
...
fsk_p3_deg <- graph_test(fsk_p3_cds2, neighbor_graph = "principal_graph", cores = 8)
...
p3_pdf <- "pooled_fsk.mesenchymal.monocle.hoxc5_early_fibroblast_to_adipocytes.trajectory_DE.20220711.pdf"
