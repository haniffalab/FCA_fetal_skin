...
kc_ad <- anndata$read_h5ad(
  "../20200626_make_figure_for_Muzz/pooled_keratinocytes.processed.h5ad")
...
fetal_kc_cds1 <- readRDS("pooled_keratinocytes.processed.fetal_hair_folicle_pcw12.monocle.cds.rds")

pdf(file="pooled_keratinocytes.processed.fetal_hair_folicle_pcw12.monocle3.20220329.pdf", width=7, height=6)
...
fetal_p1_deg <- graph_test(fetal_p1_kc_cds1, neighbor_graph = "principal_graph", cores = 8)
...
pdf(file="pooled_keratinocytes.processed.fetal_hair_folicle_pcw12.basal_postn_to_matrix_placode.monocle3.trajectory_DE.20220314.pdf", width=10, height=6)
...
fetal_p2_deg <- graph_test(fetal_p2_kc_cds, neighbor_graph = "principal_graph", cores = 8)
...
p2_pdf <- "pooled_keratinocytes.processed.fetal_hair_folicle_pcw12.basal_postn_to_companion_layer.monocle3.trajectory_DE.20220711.pdf"
...
fetal_p3_deg <- graph_test(fetal_p3_kc_cds, neighbor_graph = "principal_graph", cores = 8)
...
p3_pdf <- "pooled_keratinocytes.processed.fetal_hair_folicle_pcw12.basal_postn_to_inner_root_sheath.monocle3.trajectory_DE.20220711.pdf"
