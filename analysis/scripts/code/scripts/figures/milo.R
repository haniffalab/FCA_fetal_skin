...
sce <- readRDS(file.path(data_root, '20211022_final_figures/fetal_skin.scvi_donor.norm.sce.rds'))

obs <- read.csv(file.path(data_root, "20210611_final_object/fetal_skin.norm.maternal_removed.20220202.obs.csv.gz"), row.names=1)
...
milo <- readRDS(file.path(data_root, '20211022_final_figures/milo/fetal_skin.scvi_donor.milo.20220202.rds'))
...
results <- readRDS(file.path(data_root, '20211022_final_figures/milo/fetal_skin.scvi_donor.milo_results.20220202.rds'))
...
pdf(file=file.path(proj_root, 'figures/final/fig1C.20221010.pdf'))
plot(gp1a)
plot(gp1b)
dev.off()
...
pdf(file=file.path(proj_root, 'figures/final/figS1D.20220202.pdf'), height=10)
plot(gp2)
dev.off()
...
pdf(file=file.path(proj_root, 'figures/obsolete/FCAfetal_skin.scvi_donor.milo.independent_annotation_refined_vs_pcw.20220627.pdf'), height=10)
plot(gp3o)
dev.off()
